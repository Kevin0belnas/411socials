...
import { FaTimes, FaFilePdf, FaRegFileAlt, FaCopy, FaCheck, FaExpandArrowsAlt, FaCompressArrowsAlt, FaUser, FaBook, FaPhone, FaEnvelope, FaMapMarkerAlt, FaEdit, FaSave, FaSpinner, FaGlobe } from "react-icons/fa";
import { scriptTemplates, scriptOptions } from './scriptTemplates'; // Import from separate file

const API_URL = import.meta.env.VITE_API_URL;

// ========== MODAL WEBVIEW COMPONENT ==========
const ModalWebView = ({ url, onClose, title = "Browser" }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1003] flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl flex flex-col w-full max-w-6xl h-[85vh] overflow-hidden">
        {/* Navigation bar */}
        <div className="flex items-center gap-2 p-3 border-b border-gray-300 bg-white shrink-0">
          <button
            onClick={onClose}
          ...
          <div className="flex-1 flex items-center bg-gray-100 rounded-lg px-3 py-1.5">
            <FaGlobe className="text-gray-500 mr-2" size={14} />
          ...
          <div className="fixed inset-0 z-[1002] bg-gray-100 flex flex-col max-h-screen">
            ...
            <div className="flex-1 overflow-hidden p-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 h-full">
                  ...
                  <div className="border border-gray-300 rounded p-3">
                    ...
                    <div className="mb-2">
                      ...
                      <div className="grid grid-cols-2 gap-1">
                        <input value={bioData.street_address} readOnly className="w-full p-1.5 text-xs border rounded bg-gray-50 col-span-2" placeholder="Street" />
                        <input value={bioData.city} readOnly className="w-full p-1.5 text-xs border rounded bg-gray-50" placeholder="City" />
                        <input value={bioData.state} readOnly className="w-full p-1.5 text-xs border rounded bg-gray-50" placeholder="State" />
                        <input value={bioData.zipcode} readOnly className="w-full p-1.5 text-xs border rounded bg-gray-50" placeholder="ZIP" />
                      </div>
                    </div>
                ...
                <div className="border border-gray-300 rounded p-3">
                  <h4 className="font-semibold text-gray-800 text-sm mb-3">Subscription</h4>
